import mock01 from '../assets/images/gozochannel.png';
import mock02 from '../assets/images/bookora.jpg';
import mock03 from '../assets/images/montekristo.png';
import mock04 from '../assets/images/orderista.png';
import mock06 from '../assets/images/wakame.jpg';
import mock07 from '../assets/images/bern.jpeg';
import mock08 from '../assets/images/billynx.png';
import mock09 from '../assets/images/montekristo.png';
    ...
    return (
        <div className="projects-container" id="projects">
            ...
            <div className="projects-grid">
                ...
                <div className="project">
                    <img src={mock02} className="zoom" alt="Bookora Table Booking" width="100%" />
